...
//							IO.loadBitmapFromId(getActivity(), R.drawable.fire));
//			triangleMesh.addChild(new AnimationFaceToCamera(camera, 0.5f));
//			triangleMesh.setScale(new Vec(10, 10, 10));
//			GeoObj treangleGeo = new GeoObj(GeoObj.newRandomGeoObjAroundCamera(
//					camera, MIN_DIST, MAX_DIST), triangleMesh);
...
//			l.addModifier(new Headline(R.drawable.fire, "Lorem ipsum "
//					+ "dolor sit amet, consectetur adipisicing elit, "
//					+ "sed do eiusmod tempor incididunt ut labore et "
//					+ "dolore magna aliqua."));
//			l.addModifier(new Headline(R.drawable.fire,
...
//				"worldIconId",
//				IO.loadBitmapFromId(myTargetActivity, R.drawable.fire));
//		treangleMesh.setPosition(new Vec(0, -8, 1));
//		treangleMesh.setRotation(new Vec(0, 0, 0));
//		treangleMesh.addChild(new
//				AnimationFaceToCamera(camera, 0.5f));
